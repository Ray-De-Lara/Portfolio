...
ScrollReveal().reveal(".home__profile", { delay: 500 });
ScrollReveal().reveal(".home__title--primary", { delay: 500 });
ScrollReveal().reveal(".home__title", { delay: 600 });
ScrollReveal().reveal(".home__title--secondary", { delay: 700 });
ScrollReveal().reveal(".section__title", { delay: 500 });
ScrollReveal().reveal(".section__subtitle", { delay: 500 });
ScrollReveal().reveal(".about__description", { delay: 500 });
ScrollReveal().reveal(".about__summary", { delay: 700 });
ScrollReveal().reveal(".button--cta", { delay: 700 });
ScrollReveal().reveal(".skill__title", { delay: 600 });
